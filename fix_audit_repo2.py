...
target1 = """    suspend fun requestAiAudit(
        apiKey: String,
        periodName: String,
        year: Int,
...
replacement1 = """    suspend fun requestAiAudit(
        apiKey: String,
        periodName: String,
        year: Int,
        filteredTransactions: List<TransactionEntity>,
...
if target1 in text:
    ...
    # We can just reuse replacement_final for userQuery inside requestAiAudit as well, because it's identical text!
